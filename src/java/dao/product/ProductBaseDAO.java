...
abstract class ProductBaseDAO {
    ...
    protected Review mapReview(ResultSet rs) throws SQLException {
    ...
    protected void appendProductFilters(StringBuilder sql, List<Object> params, String keyword, String supplierId, String startDate, String endDate) {
