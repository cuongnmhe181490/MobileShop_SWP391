...
public class ProductAdminDAO extends ProductStorefrontDAO {
    ...
    public boolean updateProduct(Product product) {
        ...
        if (existing != null) {
            if (product.getCurrentQuantity() > existing.getCurrentQuantity()) {
                int restockDelta = product.getCurrentQuantity() - existing.getCurrentQuantity();
                product.setOriginalQuantity(existing.getOriginalQuantity() + restockDelta);
            }
