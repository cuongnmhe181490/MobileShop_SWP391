...
public class TopProductAddServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/config-top-product-add.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (success) {
                System.out.println("✅ Added to Top: " + productId);
            } else {
                System.err.println("❌ Failed to add to Top: " + productId);
            }
        } catch (Exception e) {
            e.printStackTrace();
            request.setAttribute("error", "Lỗi khi ghim sản phẩm: " + e.getMessage());
        }
