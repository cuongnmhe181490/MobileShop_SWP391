...
public class EditProfileControl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        // Chưa đăng nhập thì đuổi về login
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean success = userDAO.updateProfile(acc.getId(), name, phone, address, gender, birthday);
        ...
        if (success) {
            ...
            // Cập nhật birthday nếu không rỗng
            if (birthday != null && !birthday.isEmpty()) {
                try {
                    acc.setBirthday(java.sql.Date.valueOf(birthday));
