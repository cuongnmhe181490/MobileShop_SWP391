...
<head>
    ...
    <style>
        ...
        .form-control-custom:disabled { background: #e2e8f0; color: var(--text-muted); cursor: not-allowed; }
    ...
    <div class="admin-layout">
        ...
        <main class="main-content">
            <header class="page-header" style="margin-bottom: 32px;">
                ...
                <h2 style="font-size: 1.8rem; font-weight: 800; color: var(--text-main); margin: 0;">Sửa Thương hiệu</h2>
            </header>

            <div class="form-card">
                <form action="${ctx}/BrandEditServlet" method="post" enctype="multipart/form-data" id="brandForm">
                    <h4 class="section-title">📌 Thông tin cơ bản</h4>
                    
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
                                <label class="form-label">Mã Thương hiệu (ID)</label>
                                <input type="text" name="idSupplier" value="${brand.idSupplier}" class="form-control-custom" readonly disabled>
                                <input type="hidden" name="idSupplier" value="${brand.idSupplier}">
                                <p style="font-size: 0.75rem; color: var(--text-muted); margin-top: 4px;">ID không thể thay đổi sau khi tạo.</p>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="form-group" id="group-name">
                                <label class="form-label">Tên Thương hiệu <span class="text-danger">*</span></label>
                                <input type="text" name="name" id="name" value="${brand.name}" class="form-control-custom" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <div class="form-group" id="group-email">
                                ...
                                <input type="email" name="email" id="email" value="${brand.email}" class="form-control-custom" required>
                                <div class="error-msg"></div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="form-group" id="group-phoneNumber">
                                ...
                                <input type="text" name="phoneNumber" id="phoneNumber" value="${brand.phoneNumber}" class="form-control-custom">
                                <div class="error-msg"></div>
                            </div>
                        </div>
                        <div class="col-md-12 mb-4">
                            <div class="form-group" id="group-address">
                                ...
                                <input type="text" name="address" id="address" value="${brand.address}" class="form-control-custom">
                                <div class="error-msg"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4" id="group-logoFile">
                        ...
                        <div style="display: flex; align-items: flex-start; gap: 20px;">
                            <img src="${brand.logoPath}" alt="Logo hiện tại" class="current-logo">
                            <div style="flex: 1;">
                                <input type="file" name="logoFile" id="logoFile" class="form-control-custom" accept="image/*">
                                <p style="font-size: 0.8rem; color: var(--text-muted); margin-top: 8px;">Để trống nếu muốn giữ nguyên logo cũ.</p>
                            </div>
                        </div>
                        <div class="error-msg"></div>
                    </div>
                    ...
                    <div style="display: flex; justify-content: flex-end; gap: 16px; margin-top: 32px; border-top: 1px solid var(--border); padding-top: 24px;">
                        ...
                        <button type="submit" class="btn-primary" style="padding: 10px 32px; font-weight: 700;">Cập nhật <i class="fas fa-save ms-2"></i></button>
                    </div>
                </form>
            </div>
        </main>
