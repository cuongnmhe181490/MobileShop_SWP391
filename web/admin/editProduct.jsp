...
<c:set var="todayIso" value="<%= LocalDate.now().toString() %>" />
<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
...
<body>
        ...
        <aside class="sidebar">
            ...
            <div class="nav-section">
                ...
                <ul class="sidebar-menu">
                    <li class="menu-item"><a href="${ctx}/admin/dashboard" class="menu-link"><i class="fa-solid fa-chart-line"></i>Dashboard</a></li>
                </ul>
            </div>
            ...
            <div class="nav-section">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="menu-item"><a href="${ctx}/admin/accounts" class="menu-link"><i class="fa-solid fa-user-gear"></i>Tài khoản</a></li>
                </ul>
            </div>
            ...
            <div class="nav-section">
                ...
                <ul class="sidebar-menu">
                    <li class="menu-item"><a href="${ctx}/admin/contacts" class="menu-link"><i class="fa-solid fa-envelope-open-text"></i>Liên hệ / Tư vấn</a></li>
                    <li class="menu-item"><a href="${ctx}/admin/reviews" class="menu-link"><i class="fa-solid fa-star"></i>Đánh giá</a></li>
                    <li class="menu-item"><a href="${ctx}/admin/blog" class="menu-link"><i class="fa-solid fa-newspaper"></i>Blog / Tin tức</a></li>
                </ul>
            </div>
            ...
            <div class="nav-section">
                ...
                <ul class="sidebar-menu">
                    <li class="menu-item"><a href="${ctx}/admin-home-config.jsp" class="menu-link"><i class="fa-solid fa-house-chimney-window"></i>Trang chủ</a></li>
                </ul>
            </div>

            <div style="margin-top: auto; padding-bottom: 24px;">
                <ul class="sidebar-menu">
                    <li class="menu-item"><a href="${ctx}/home" class="menu-link"><i class="fa-solid fa-globe"></i>Xem Website</a></li>
                    <li class="menu-item"><a href="${ctx}/logout" class="menu-link"><i class="fa-solid fa-power-off"></i>Đăng xuất</a></li>
                </ul>
            </div>
        </aside>
                ...
                <form id="productForm" action="${ctx}/admin/products?service=${editMode ? 'editProduct' : 'addProduct'}" method="POST" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="product-form-grid">
                        <label class="field-block">
                            ...
                            <input class="form-control form-input admin-product-input" type="text" name="productName" value="${param.productName != null ? param.productName : productForm.productName}" minlength="2" maxlength="200" required ${viewMode ? 'disabled' : ''}>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    ...
                                    <div class="input-suffix-wrap">
                                        <input class="form-control form-input admin-product-input admin-product-input--suffix" type="text" inputmode="numeric" pattern="[1-9][0-9]*" name="price" id="price" value="${param.price != null ? param.price : formattedPriceValue}" required>
                        ...
                        <label class="field-block">
                            ...
                            <input class="form-control form-input admin-product-input" type="text" inputmode="numeric" pattern="[0-9]*" name="quantity" id="quantity" value="${param.quantity != null ? param.quantity : productForm.quantity}" required ${viewMode ? 'disabled' : ''}>
                            <span class="field-error" data-error-for="quantity">${errors.quantity}</span>
                        </label>

                        <label class="field-block">
                            <span class="field-label">Ngày ra mắt</span>
                            <input class="form-control form-input admin-product-input" type="date" name="releaseDate" value="${param.releaseDate != null ? param.releaseDate : productForm.releaseDate}" max="${todayIso}" ${viewMode ? 'disabled' : ''}>
                        ...
                        <label class="field-block">
                            ...
                            <select class="form-select admin-product-input" name="idSupplier" id="idSupplier" required ${viewMode ? 'disabled' : ''}>
                                <option value="">-- Chn nhà cung cấp --</option>
                        ...
                        <label class="field-block">
                            ...
                            <input class="form-control form-input admin-product-input" type="text" name="ram" id="ram" value="${param.ram != null ? param.ram : productForm.ram}" maxlength="50" inputmode="numeric" ${viewMode ? 'disabled' : ''}>
                        ...
                        <label class="field-block">
                            ...
                            <input class="form-control form-input admin-product-input" type="text" name="battery" value="${param.battery != null ? param.battery : productForm.battery}" maxlength="5" inputmode="numeric" pattern="[1-9][0-9]{0,4}" required ${viewMode ? 'disabled' : ''}>
    ...
    <script>
        ...
        const batteryInput = form ? form.elements['battery'] : null;
        const releaseDateInput = form ? form.elements['releaseDate'] : null;
        ...
        function validateNonNegative(fieldName, isInteger) {
            ...
            if (!Number.isFinite(number)) {
                setError(fieldName, isInteger ? 'Chỉ được nhập số nguyên.' : 'Chỉ được nhập số hợp lệ.');
                return true;
            }
            if (number < 0) {
                setError(fieldName, 'Giá trị không được âm.');
                return true;
            }
            if (isInteger && !Number.isInteger(number)) {
                setError(fieldName, 'Chỉ được nhập số nguyên.');
                return true;
            }
            return false;
        }
        ...
        function validateMaxLength(fieldName, maxLength, message) {
            ...
            const limits = {
                productName: [200, 'Tên sản phẩm không được vượt quá 200 ký tự.'],
                screen: [200, 'Màn hình không được vượt quá 200 ký tự.'],
                operatingSystem: [100, 'Hệ điu hành không được vượt quá 100 ký tự.'],
                cpu: [100, 'CPU không được vượt quá 100 ký tự.'],
                ram: [50, 'RAM không được vượt quá 50 ký tự.'],
                camera: [200, 'Camera không được vượt quá 200 ký tự.'],
                battery: [5, 'Pin không được vượt quá 5 ký tự.'],
                description: [2000, 'Mô tả không được vượt quá 2000 ký tự.']
            };
            if (limits[fieldName]) {
                maxLength = limits[fieldName][0];
                message = limits[fieldName][1];
            }
        ...
        function validatePositiveIntegerNoLeadingZero(fieldName, label) {
            const input = form.elements[fieldName];
            const value = input.value.trim();
            if (!value) {
                return false;
            ...
            if (!/^[0-9]+$/.test(value)) {
                setError(fieldName, label + ' phải là số nguyên dương.');
                return true;
            }
            if (value.length > 1 && value.startsWith('0')) {
                setError(fieldName, label + ' không được bắt đầu bằng số 0.');
                return true;
            }
            if (Number(value) <= 0) {
                setError(fieldName, label + ' phải lớn hơn 0.');
                return true;
            }
            return false;
        }
        ...
        function restrictNumericInput(input, allowDecimal) {
            if (!input) {
                return;
            }
            ...
            input.addEventListener('input', () => {
                ...
                nextValue = allowDecimal ? nextValue.replace(/[^0-9.]/g, '') : nextValue.replace(/[^0-9]/g, '');
                if (allowDecimal) {
                    const firstDotIndex = nextValue.indexOf('.');
                    if (firstDotIndex !== -1) {
                        nextValue = nextValue.substring(0, firstDotIndex + 1)
        ...
        if (!viewMode) {
            restrictNumericInput(priceInput, false);
            restrictNumericInput(quantityInput, false);
            restrictNumericInput(ramInput, false);
            restrictNumericInput(batteryInput, false);
            ...
            form.addEventListener('submit', async (event) => {
                ...
                ['productName', 'idSupplier', 'price', 'quantity', 'battery'].forEach((field) => {
                    if (!form.elements[field].value.trim()) {
                        setError(field, 'Trưng này là bắt buộc.');
                        hasError = true;
                    }
                });

                hasError = validatePositiveIntegerNoLeadingZero('price', 'Giá') || hasError;
                hasError = validateNonNegative('quantity', true) || hasError;
                if (ramInput.value.trim()) {
                    hasError = validateNonNegative('ram', true) || hasError;
                }
                if (batteryInput) {
                    hasError = validatePositiveIntegerNoLeadingZero('battery', 'Pin') || hasError;
                }
                ...
                hasError = validateMaxLength('battery', 5, 'Pin không được vượt quá 5 ký tự.') || hasError;
                ...
                if (releaseDateInput && releaseDateInput.value) {
                    ...
                    const selectedDate = new Date(releaseDateInput.value + 'T00:00:00');
                    if (selectedDate > today) {
                        setError('releaseDate', 'Ngày ra mắt không được lớn hơn ngày hiện tại.');
                        hasError = true;
                    }
                }
