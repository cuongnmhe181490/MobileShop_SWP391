...
<body>
    ...
    <div class="main-content">
        ...
        <div class="info-card" style="max-width: 900px;">
            ...
            <form id="blogForm" action="${pageContext.request.contextPath}/admin/blog?service=insertBlog" 
                  method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                <div class="row">
                    <div class="col-md-8">
                        <div class="mb-4">
                            <label class="form-label fw-bold">Tiêu đề bài viết <span class="text-danger">*</span></label>
                            <input type="text" name="title" class="form-control" placeholder="Nhập tiêu đề (tối đa 255 ký tự)..." 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="subTitle" class="form-control" placeholder="Ví dụ: Đánh giá nhanh, Tin hot... (tối đa 255 ký tự)" 
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="summary" class="form-control" rows="3" required maxlength="500"
                                      placeholder="Viết mô tả ngắn gọn về bài viết (tối đa 500 ký tự)..." 
                                      style="padding: 0.75rem; border-radius: 0.75rem;"></textarea>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold">Ảnh đại diện (Thumbnail) <span class="text-danger">*</span></label>
                            ...
                            <div id="imageFeedback" class="invalid-feedback">Vui lòng chọn ảnh đại diện (định dạng: jpg, png, webp... và < 5MB).</div>
                            <div class="form-text mt-2">Nên chọn ảnh kích thước 1200x800px.</div>
                            
                            <!-- Image Preview Workspace -->
                            <div id="imagePreview" class="mt-3 d-none">
                                <p class="small mb-1 fw-bold">Xem trước ảnh:</p>
                                <img src="" id="imgPreview" class="rounded shadow-sm" style="max-width: 100%; height: auto; border: 1px solid #eee;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="content" class="form-control" rows="12" required 
                              placeholder="Nhập nội dung bài viết kỹ lưỡng ở đây..." 
                              style="padding: 1rem; border-radius: 1rem;"></textarea>
