...
<head>
    ...
    <style>
        ...
        .upload-area { border: 2px dashed var(--border); border-radius: 12px; padding: 3rem 1rem; text-align: center; cursor: pointer; background: #f8fafc; position: relative; transition: 0.2s; }
        .upload-area:hover { border-color: var(--primary); background: #f1f5f9; }
        .upload-area i { font-size: 2.8rem; color: #94a3b8; margin-bottom: 1.2rem; }
        .upload-area input { position: absolute; opacity: 0; inset: 0; cursor: pointer; }

        .preview-img-box { margin-top: 1.5rem; border-radius: 12px; overflow: hidden; border: 1px solid var(--border); display: none; }
    ...
    <div class="admin-wrapper">
        ...
        <main class="main-content">
            <div class="header-title-area">
                <div>
                    <span class="eyebrow">QUẢN LÝ NỘI DUNG</span>
                    <h1>Tạo bài viết mới</h1>
                </div>
                <a href="javascript:history.back()" class="btn-return">Quay lại</a>
            </div>
                    ...
                    <div class="row g-5">
                        <div class="col-lg-8">
                            <div class="form-group-wrap">
                                ...
                                <input type="text" name="title" id="titleInput" class="input-premium" required maxlength="255">
                                <div class="char-counter" id="titleCounter">0 / 255</div>
                            </div>

                            <div class="form-group-wrap">
                                <label class="form-label-bold">PHỤ ĐỀ (SUBTITLE)</label>
                                <input type="text" name="subTitle" id="subTitleInput" class="input-premium" maxlength="255">
                            ...
                            <div class="form-group-wrap">
                                ...
                                <textarea name="description" id="descInput" class="input-premium textarea-premium" required maxlength="255"></textarea>
                            ...
                            <div class="form-group-wrap mb-0">
                                ...
                                <textarea name="content" id="blogContent" class="input-premium textarea-premium" style="min-height: 400px;" required maxlength="4000"></textarea>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group-wrap">
                                <label class="form-label-bold">ẢNH BÀI VIẾT <span class="text-danger">*</span></label>
                            ...
                            <div class="note-box">
                                <h4><i class="fa-solid fa-lightbulb"></i> Lưu ý</h4>
                                <p>Nội dung sẽ hiển thị ngay sau khi đăng. Hãy đảm bảo nội dung đã được kiểm duyệt kỹ càng.</p>
                            </div>
                        </div>
                    </div>

                    <div class="action-bar">
                        <button type="button" onclick="window.history.back()" class="btn-p btn-cancel">Hủy bỏ</button>
                        <button type="submit" class="btn-p btn-submit">Đăng bài viết</button>
                    </div>
                </form>
            </div>
        </main>
    ...
    <script>
        ...
        function loadCategoryList() {
            ...
            fetch(url)
                ...
                .then(data => {
                    let html = '';
                    let selectHtml = '<option value="" disabled selected>-- Chọn danh mục --</option>';
                    data.forEach(cat => {
